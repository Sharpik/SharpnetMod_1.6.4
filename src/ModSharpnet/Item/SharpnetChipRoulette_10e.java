...
public class SharpnetChipRoulette_10e extends Item
{
    
    private int blockType;
    private int blockMetaData;
    
    public SharpnetChipRoulette_10e(int par1)
    {
        super(par1);
                ...
                if( (blockMetaData == 7) || (blockMetaData == 8) )
                {
                    ...
                    if (!par3World.isRemote)
                    {
                        ...
                        if(random)
                        {
                            ...
                            par2EntityPlayer.sendChatToPlayer(ChatMessageComponent.createFromText("And You won: 20 EU!"));
                        }
