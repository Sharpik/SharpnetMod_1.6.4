...
public class ShItemFoodPlacer extends Item
{
    ...
    public ShItemFoodPlacer(int par1, int par2, float par3, boolean par4, int blockID, int blockMeta, int DrunkType, int DrunkVal)
    {
        super(par1);
    ...
    public ShItemFoodPlacer(int par1, int par2, boolean par3, int blockID, int blockMeta, int DrunkType, int DrunkVal)
    {
     ...
     */
    public ShItemFoodPlacer setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
     ...
     */
    public ShItemFoodPlacer setAlwaysEdible()
    {
