...
public class SharpnetTilesWoodSlabBlocks1 extends BlockHalfSlab
{
    
    public SharpnetTilesWoodSlabBlocks1(int par1, boolean par2, Material par3Material)
    {
        super(par1, par2, Material.wood);
        setUnlocalizedName("TilesWoodSlabBlocks1Block");
    ...
    public void registerIcons(IconRegister par1)
    {
        ...
        for (int i = 0; i < icons.length; i++)
        {
            switch(i)
            {
                case 0:{icons[i] = par1.registerIcon(modid+":tiles_wood/w_floor1_white");break;}
                case 1:{icons[i] = par1.registerIcon(modid+":tiles_wood/w_floor1_black");break;}
                case 2:{icons[i] = par1.registerIcon(modid+":tiles_wood/w_floor1_blue");break;}
                case 3:{icons[i] = par1.registerIcon(modid+":tiles_wood/w_floor1_green");break;}
                case 4:{icons[i] = par1.registerIcon(modid+":tiles_wood/w_floor1_orange");break;}
