...
public class ModSharpnet
{
    ...
    public void load(FMLInitializationEvent event)
    {
        ...
        */
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_cobblestone_trowel,8,0), new ItemStack(Blocks.wall_cobblestone_trowel,8,12), new ItemStack(Item.dyePowder, 1, 15)); //White
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_cobblestone_trowel,8,1), new ItemStack(Blocks.wall_cobblestone_trowel,8,12), new ItemStack(Item.dyePowder, 1, 14)); //Orange
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_cobblestone_trowel,8,2), new ItemStack(Blocks.wall_cobblestone_trowel,8,12), new ItemStack(Item.dyePowder, 1, 13)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_cobblestone_trowel,8,3), new ItemStack(Blocks.wall_cobblestone_trowel,8,12), new ItemStack(Item.dyePowder, 1, 12)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_cobblestone_trowel,8,4), new ItemStack(Blocks.wall_cobblestone_trowel,8,12), new ItemStack(Item.dyePowder, 1, 11)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_cobblestone_trowel,8,5), new ItemStack(Blocks.wall_cobblestone_trowel,8,12), new ItemStack(Item.dyePowder, 1, 10)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_cobblestone_trowel,8,6), new ItemStack(Blocks.wall_cobblestone_trowel,8,12), new ItemStack(Item.dyePowder, 1, 9)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_cobblestone_trowel,8,7), new ItemStack(Blocks.wall_cobblestone_trowel,8,12), new ItemStack(Item.dyePowder, 1, 8)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_cobblestone_trowel,8,8), new ItemStack(Blocks.wall_cobblestone_trowel,8,12), new ItemStack(Item.dyePowder, 1, 7)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_cobblestone_trowel,8,9), new ItemStack(Blocks.wall_cobblestone_trowel,8,12), new ItemStack(Item.dyePowder, 1, 6)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_cobblestone_trowel,8,10), new ItemStack(Blocks.wall_cobblestone_trowel,8,12), new ItemStack(Item.dyePowder, 1, 5)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_cobblestone_trowel,8,11), new ItemStack(Blocks.wall_cobblestone_trowel,8,12), new ItemStack(Item.dyePowder, 1, 4)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_cobblestone_trowel,8,13), new ItemStack(Blocks.wall_cobblestone_trowel,8,12), new ItemStack(Item.dyePowder, 1, 2)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_cobblestone_trowel,8,14), new ItemStack(Blocks.wall_cobblestone_trowel,8,12), new ItemStack(Item.dyePowder, 1, 1)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_cobblestone_trowel,8,15), new ItemStack(Blocks.wall_cobblestone_trowel,8,12), new ItemStack(Item.dyePowder, 1, 0)); //Black
        
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_bricks_trowel,1,12), new ItemStack(Block.brick,1,0), Item.clay);
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_bricks_trowel,8,0), new ItemStack(Blocks.wall_bricks_trowel,8,12), new ItemStack(Item.dyePowder, 1, 15)); //White
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_bricks_trowel,8,1), new ItemStack(Blocks.wall_bricks_trowel,8,12), new ItemStack(Item.dyePowder, 1, 14)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_bricks_trowel,8,2), new ItemStack(Blocks.wall_bricks_trowel,8,12), new ItemStack(Item.dyePowder, 1, 13)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_bricks_trowel,8,3), new ItemStack(Blocks.wall_bricks_trowel,8,12), new ItemStack(Item.dyePowder, 1, 12)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_bricks_trowel,8,4), new ItemStack(Blocks.wall_bricks_trowel,8,12), new ItemStack(Item.dyePowder, 1, 11)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_bricks_trowel,8,5), new ItemStack(Blocks.wall_bricks_trowel,8,12), new ItemStack(Item.dyePowder, 1, 10)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_bricks_trowel,8,6), new ItemStack(Blocks.wall_bricks_trowel,8,12), new ItemStack(Item.dyePowder, 1, 9)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_bricks_trowel,8,7), new ItemStack(Blocks.wall_bricks_trowel,8,12), new ItemStack(Item.dyePowder, 1, 8)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_bricks_trowel,8,8), new ItemStack(Blocks.wall_bricks_trowel,8,12), new ItemStack(Item.dyePowder, 1, 7)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_bricks_trowel,8,9), new ItemStack(Blocks.wall_bricks_trowel,8,12), new ItemStack(Item.dyePowder, 1, 6)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_bricks_trowel,8,10), new ItemStack(Blocks.wall_bricks_trowel,8,12), new ItemStack(Item.dyePowder, 1, 5)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_bricks_trowel,8,11), new ItemStack(Blocks.wall_bricks_trowel,8,12), new ItemStack(Item.dyePowder, 1, 4)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_bricks_trowel,8,13), new ItemStack(Blocks.wall_bricks_trowel,8,12), new ItemStack(Item.dyePowder, 1, 2)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_bricks_trowel,8,14), new ItemStack(Blocks.wall_bricks_trowel,8,12), new ItemStack(Item.dyePowder, 1, 1)); //
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wall_bricks_trowel,8,15), new ItemStack(Blocks.wall_bricks_trowel,8,12), new ItemStack(Item.dyePowder, 1, 0)); //Black
