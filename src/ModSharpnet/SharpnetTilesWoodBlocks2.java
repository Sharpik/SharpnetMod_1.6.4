...
public class SharpnetTilesWoodBlocks2 extends Block
{

    public SharpnetTilesWoodBlocks2(int par1,String par2Material)
    {
        super(par1, Material.wood);
        setUnlocalizedName("Sharpnet Tiles Wood Blocks 2");
