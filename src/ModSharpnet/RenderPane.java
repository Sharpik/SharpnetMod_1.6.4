...
import ModSharpnet.Block.SharpnetPanelsBlock;
 ...
 * 
 */
public class RenderPane implements ISimpleBlockRenderingHandler
{
	final int renderID;

	public RenderPane(int var1)
	{
		this.renderID = var1;
	}

	public void renderPaneInWorld(RenderBlocks renderBlocks, IBlockAccess iblockaccess, Block par1Block, int x, int y, int z)
	{
		...
		renderBlocks.setOverrideBlockTexture(((SharpnetPanelsBlock) par1Block).getSideTextureIndex(metadata));
	...
	{
		this.renderPaneInWorld(renderer, world, block, x, y, z);
		return true;
	}
