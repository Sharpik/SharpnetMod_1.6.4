...
public class SharpnetTilesWoodBlocks1 extends Block
{

    public SharpnetTilesWoodBlocks1(int par1,String par2Material)
    {
        super(par1, Material.wood);
        setUnlocalizedName("Sharpnet Tiles Wood Blocks 1");
        setHardness(1.0F).setStepSound(Block.soundWoodFootstep);
        setResistance(2.0F);
        setBurnProperties(par1, 5, 20);
