...
public class SharpnetTilesSlabBlocks3 extends BlockHalfSlab
{
    
    public SharpnetTilesSlabBlocks3(int par1, boolean par2, Material par3Material)
    {
        super(par1, par2, Material.rock);
        setUnlocalizedName("TilesSlabBlocks3Block");
