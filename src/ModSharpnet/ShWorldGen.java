            ...
            */
            ...
            if( (biome_type == "Forest") || (biome_type == "ForestHills") )
            {
                ...
                if(ModSharpnet.WorldGenFlowers)
                {
                    ...
                    //Okee Giant
                        FlowerSpawner(world, chunkX, chunkZ, random, SharpnetFlowerBlocks1ID, 13, 58, 186, 2, false);
                    //Mantis Shrimp
                    ...
                    //Mechus 1
                        FlowerSpawner(world, chunkX, chunkZ, random, SharpnetFlowerBlocks2ID, 0, 58, 186, 11, true);
                    //Sukulentus 1
                        FlowerSpawner(world, chunkX, chunkZ, random, SharpnetFlowerBlocks2ID, 1, 58, 186, 1, false);
                    //Sukulentus 2
                        FlowerSpawner(world, chunkX, chunkZ, random, SharpnetFlowerBlocks2ID, 2, 58, 186, 2, false);
                    //Sukulentus 3
            ...
            if( (biome_type == "Jungle") || (biome_type == "JungleHills") )
            {
                ...
                if(ModSharpnet.WorldGenFlowers)
                {
                    ...
                    //Yellow Dicot
                        FlowerSpawner(world, chunkX, chunkZ, random, SharpnetFlowerBlocks1ID, 11, 58, 186, 1, false);
                    //Bird of Paradise
                        FlowerSpawner(world, chunkX, chunkZ, random, SharpnetFlowerBlocks1ID, 12, 58, 186, 3, true);
                    //Okee Giant
                    ...
                    //Bush 1
                        FlowerSpawner(world, chunkX, chunkZ, random, SharpnetBushesBlocksID, 0, 58, 186, 3, true);
                }
            ...
            if(biome_type == "Extreme Hills")
            {
                ...
                if(ModSharpnet.WorldGenFlowers)
                {
                    ...
                    //Snap Dragon
                        FlowerSpawner(world, chunkX, chunkZ, random, SharpnetFlowerBlocks1ID, 5, 58, 186, 1, true);                    
                    //Bonsai
                        FlowerSpawner(world, chunkX, chunkZ, random, SharpnetFlowerBlocks1ID, 4, 58, 186, 3, true);
                    //Lacustrine
                        FlowerSpawner(world, chunkX, chunkZ, random, SharpnetFlowerBlocks1ID, 10, 58, 186, 5, true);
                    //Sukulentus 2
                        FlowerSpawner(world, chunkX, chunkZ, random, SharpnetFlowerBlocks2ID, 2, 58, 186, 2, true);
                    //Bush 1
                        FlowerSpawner(world, chunkX, chunkZ, random, SharpnetBushesBlocksID, 0, 58, 186, 2, true);
                }
            ...
            if(biome_type == "Swampland")
            {
                ...
                if(ModSharpnet.WorldGenFlowers)
                {
                    ...
                    //Okee Giant
                        FlowerSpawner(world, chunkX, chunkZ, random, SharpnetFlowerBlocks1ID, 13, 58, 186, 3, true);
                }
