...
public class SharpnetBlocksSubtypes extends Block
{
    public int dropID = 0;
    public int dropMeta = 0;
    public int dropCount = 0;
    
    public SharpnetBlocksSubtypes(int par1, Material material, String[][] blocksInfo)
    {
        super(par1, material);
        ...
        for (int i = 0; i < icons.length; i++)
        {
            switch(i)
            {
                ...
                case 7:
                {
                    isSided[i] = true;
                    // TOP
                    topIcon[i] = par1.registerIcon(modid+":others/roulette_top2");
                    // BOTTOM
                    bottomIcon[i] = par1.registerIcon(modid+":others/roulette_bottom");
                    // SIDES
                    sideIcon[i] = par1.registerIcon(modid+":others/roulette_side");
                ...
                case 8:
                {
                    isSided[i] = true;
                    // TOP
                    topIcon[i] = par1.registerIcon(modid+":others/roulette_top3");
                    // BOTTOM
                    bottomIcon[i] = par1.registerIcon(modid+":others/roulette_bottom");
                    // SIDES
                    sideIcon[i] = par1.registerIcon(modid+":others/roulette_side");
