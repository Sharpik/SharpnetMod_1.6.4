...
public class SharpnetLightingStickBlock1 extends Block
{
    public SharpnetLightingStickBlock1(int par1)
    {
        super(par1, Material.circuits);
        this.setHardness(0.0F);
        this.setLightValue(1.0F);
        this.setStepSound(soundWoodFootstep);
        this.setUnlocalizedName("lighting_stick_block");
        this.setTextureName(modid+":others/lighting_stick");
